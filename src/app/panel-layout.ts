    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">HEIMDALL</span><span class="logo-mobile">HEIMDALL</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">HEIMDALL</span>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">HEIMDALL</span>
        ...
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} HEIMDALL &middot; fork of <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener" style="color:inherit;">World Monitor</a></span>
      </footer>
