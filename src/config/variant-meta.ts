...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'HEIMDALL - Real-Time Global Intelligence Dashboard',
    description: 'Real-time global intelligence platform. Conflicts, markets, military, OSINT in one view. A personal fork of World Monitor.',
